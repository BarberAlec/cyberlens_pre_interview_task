...
The program is initiated via the instantiation of a \mbox{\hyperlink{classProducer}{Producer}} object. The \mbox{\hyperlink{classProducer}{Producer}} object, constructs three \mbox{\hyperlink{classConsumer}{Consumer}} objects and begins their operation in a new thread (begin\+\_\+thread()). Each consumer thread continually searches both the job queue and command queue for new tasks and commands respectively.
